...
这是一个 **单 HTML 文件的 OpenCSG 投资人路演材料**，共 38 页、1600×900 16:9 设计稿，支持在线演示、导出 PDF / PPTX（图片式）、多语言切换、键盘翻页、缩略图概览、嵌入式二维码等。
...
| 模块 | 关键能力 |
| --- | --- |
| 📑 **多页幻灯** | 38 页，cover / main / case / product / appendix 五大分节，每节可独立导出 |
...
├── index.html                # 入口页面，38 张 slide 全部写在这里
├── assets/
│   ├── deck-*.css / .js      # 幻灯样式与脚本
│   ├── i18n/                 # 10 国翻译包
│   ├── brand-logos/          # 品牌 logo
